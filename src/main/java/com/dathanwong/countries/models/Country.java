package com.dathanwong.countries.models;
...
public class Country {
	...
	private Double life_expenctancy;
	private Double gnp;
	...
	public double getLife_expenctancy() {
		return life_expenctancy;
	}

	public void setLife_expenctancy(double life_expenctancy) {
		this.life_expenctancy = life_expenctancy;
	}
